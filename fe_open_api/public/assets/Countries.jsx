export const Countries = {
    countries: [
        ...
        { name: "Azerbaijan", code: "AZ", currency: "AZM" },
        ...
        { name: "China", code: "CN", currency: "RMB" },
        ...
        { name: "Iraq", code: "IQ", currency: "NID" },
        ...
        { name: "Mozambique", code: "MZ", currency: "MZM" },
        ...
        { name: "Romania", code: "RO", currency: "ROL" },
        ...
        { name: "South Georgia and the South Sandwich Islands", code: "GS", currency: "FKP" },
        { name: "Spain", code: "ES", currency: "EUR" },
        { name: "Sri Lanka", code: "LK", currency: "LKR" },
        { name: "Sudan", code: "SD", currency: "SDG" },
        { name: "Suriname", code: "SR", currency: "SRG" },
        ...
        { name: "Venezuela", code: "VE", currency: "VEB" },
        ...
        { name: "Zambia", code: "ZM", currency: "ZMK" },
