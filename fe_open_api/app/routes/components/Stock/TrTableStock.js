...
const name = [
    <React.Fragment key="name-1">
        <span className="text-inverse">Caterpillar</span>
        {" "}
        <small>(CAT)</small>
    </React.Fragment>,
    <React.Fragment key="name-2">
        <span className="text-inverse">Google</span>
        {" "}
        <small>(GOOGL)</small>
    </React.Fragment>,
    <React.Fragment key="name-3">
        <span className="text-inverse">Microsoft</span>
        {" "}
        <small>(MSFT)</small>
    </React.Fragment>,
...
const price = [
    <React.Fragment key="price1">
        <span className="text-success">
            <i className="fa fa-caret-up mr-1" />
            {" "}
